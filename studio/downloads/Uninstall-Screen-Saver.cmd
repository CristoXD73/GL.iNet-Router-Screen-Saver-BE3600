@echo off
rem Double-click me. Takes the screen saver off your GL.iNet GL-BE3600 (Slate 7), and puts its normal screen back.
rem It asks for your router's admin password in this window only, and tells you each step.
title GL.iNet Router Screen Saver - Uninstall
set "SELF=%~f0"
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%PSF%" -Uninstall %*
set "RC=%ERRORLEVEL%"
del "%PSF%" >nul 2>&1
exit /b %RC%
##PS-CODE##
